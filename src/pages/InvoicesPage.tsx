...
export default function InvoicesPage() {
  ...
  const loadInvoices = async () => {
    ...
    try {
      ...
      if (!isTrainerOrAdmin) {
        // Athletes only see their own invoices
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            {language === 'es'
              ? 'Genera y gestiona facturas para tus clientes'
      ...
      {view === 'list' && (
        <div className="space-y-4">
          {/* Filters */}
          <div className="flex items-center gap-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
