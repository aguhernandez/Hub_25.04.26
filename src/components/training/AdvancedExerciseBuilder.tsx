          ...
          <div className="flex items-center gap-3">
            ...
            {exerciseHistory ? (
              <button
                ...
                title={language === 'es' ? 'Ver estadísticas del ejercicio' : 'View exercise stats'}
              >
              ...
              <button
                onClick={() => setShowStatsPanel(true)}
                className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors cursor-pointer"
                title={language === 'es' ? 'Ver estadísticas del ejercicio' : 'View exercise stats'}
              >
