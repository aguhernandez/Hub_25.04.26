...
interface ProgramTagsSectionProps {
  programId: string;
  language?: string;
  canEdit?: boolean;
}

export default function ProgramTagsSection({ programId, language = 'en', canEdit = false }: ProgramTagsSectionProps) {
  const { tagIds, setTagIds } = useTags('program', programId);
